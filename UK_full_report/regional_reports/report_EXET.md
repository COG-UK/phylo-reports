...
This report gives summaries of UK specific lineages sequenced by EXET for week 2020-05-29. 
...
89 are lineages which only contained five sequences or fewer, and so have been left out of visualisation in the interests of clarity
...
| UK701          | 13 (100.0%) | Mar-22, May-01 |                13 | B.1              |                              12 |           0.2778 |
| UK63           | 11 (100.0%) | Apr-09, May-05 |                11 | B.1.1            |                               8 |           0.325  |
...
![Number of sequences sampled in a lineage by country](UK_full_report/regional_reports/results/results_EXET/figures/report_EXET_stacked_bars_by_country_1.png){#stacked_bars_by_country }
...
![Lag since the most recent sequence from each sequencing centre to most current date](UK_full_report/regional_reports/results/results_EXET/figures/report_EXET_lag_fig_1.png){#lag_fig }
...
![Lineages by number of adm2 regions present by epiweek](UK_full_report/regional_reports/results/results_EXET/figures/report_EXET_geog_plot_1.png){#geog_plot }
...
![Timeline of lineages, sized by number of sequences from each country.](UK_full_report/regional_reports/results/results_EXET/figures/report_EXET_make_timeline_1.png){#make_timeline }
...
![Lineage starts per week, split by singletons and non-singletons](UK_full_report/regional_reports/results/results_EXET/figures/report_EXET_firsts_plot_1.png){#firsts_plot }

For comparison, here is a plot of the day that every sequence was taken, coloured by country. Note that sequences without dates were not included.


![Sequences taken on each day by country](UK_full_report/regional_reports/results/results_EXET/figures/report_EXET_seqs_over_time_1.png){#seqs_over_time }
...
![Map showing the number of sequences sampled by adm2 region](UK_full_report/regional_reports/results/results_EXET/figures/report_EXET_map_1.png){#map }
...
| Week commencing   |   UK476 |   UK283 |   UK701 |   UK63 |
|:------------------|--------:|--------:|--------:|-------:|
| 2020-03-22        |       0 |       1 |       1 |      0 |
| 2020-03-29        |       1 |       1 |       1 |      0 |
| 2020-04-05        |       1 |       1 |       1 |      1 |
