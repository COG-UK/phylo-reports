...
---------------------------------------------------------------------------NameError                                 Traceback (most recent call last)<ipython-input-1-54ed8d76867c> in <module>
      1 print("![](" + fd + "/" + name_stem + "_seqs_over_time_1.png)\\")
----> 2 print(raw_data_seqs_over_time.to_markdown())
NameError: name 'raw_data_seqs_over_time' is not defined
