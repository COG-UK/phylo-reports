...
if $TREES
then 
generate_report --m UK_full_report/results/$WEEK/report_files/cog_gisaid.lineages.with_all_traits.with_phylotype_traits.csv  --w $WEEK --s UK_report_$WEEK --od UK_full_report/results/$WEEK/ --i UK_full_report/results/$WEEK/tree_files/
else
generate_report --m UK_full_report/results/$WEEK/report_files/cog_gisaid.lineages.with_all_traits.with_phylotype_traits.csv --w $WEEK --s UK_report_$WEEK --od UK_full_report/results/$WEEK/
